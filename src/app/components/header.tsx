        ...
        <header className="border-b border-[hsl(var(--primary))]/30 bg-[hsl(var(--background))]/80 backdrop-blur-xl sticky top-0 z-50">
            <div className="container mx-auto px-4 py-4 flex justify-between items-center">
                ...
                <nav className={`hidden md:flex space-x-6 ${isSignedIn ? 'mr-30' : ''}`}>
                    <Link href="/" className="hover:text-[hsl(var(--primary))] transition-colors hover:cursor-pointer">
                        Home
                    </Link>
                    <Link href="#pricing" className="hover:text-[hsl(var(--primary))] transition-colors hover:cursor-pointer">
                        Pricing
                    </Link>
                    <Link href="#gallery" className="hover:text-[hsl(var(--primary))] transition-colors hover:cursor-pointer">
                        Gallery
                    </Link>
                </nav>
            ...
            <div className={`md:hidden transition-all duration-300 overflow-hidden ${mobileMenuOpen ? 'max-h-40 py-2' : 'max-h-0'}`}>
                <nav className="flex flex-col space-y-2 px-4 bg-[hsl(var(--background))]">
                    <Link href="/" 
                        className="hover:text-[hsl(var(--primary))] transition-colors hover:cursor-pointer py-2 text-center"
